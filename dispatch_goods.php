    ...
    <div class="container-fluid">
        <div class="main-card">
            ...
            <div class="lot-section" id="lotSection">
                <h4><i class="fas fa-boxes"></i> เลือก Lot ที่ต้องการจ่าย</h4>
            ...
            tr.innerHTML = `
                ...
                <td>
                    <div class="quick-fill">
                        ...
                        <button type="button" onclick="document.getElementById('qty_${index}').value='${availableQty}'" title="เต็มจำนวน">MAX</button>
                    </div>
                </td>
                <td>
                    <div class="quick-fill">
